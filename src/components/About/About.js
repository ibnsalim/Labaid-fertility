    ...
    >
      <div className='relative aspect-w-16 aspect-h-9'>
        ...
        <div class="absolute top-0 flex justify-center items-center w-full h-full ">        
          ...
          initial={{ scale: 1 }}
          animate={{ scale: 1.3 }}
          class="font-semibold  text-4xl mb-3 font-[roboto] text-white m-6 hover:s ">OUR HONORABLE DOCTORS</motion.h1>
        </div>
      </div>
        ...
        {/* Labaid fertility center */}
          ...
          <div className='grid grid-cols-5'>
              ...
              <div className='col-span-3 mt-4 space-y-5 flex flex-col justify-center items-center'>
                  ...
                  whileTap={{ scale: 0.8 }}
                  className='flex justify-center text-md font-semibold rounded-full px-4 text-gray-100 bg-[#369b9b] tracking-wider mt-4 p-2 shadow-lg hover:cursor-pointer ' onClick={() => {navigate(`/doctors`, { replace: true })}}>Learn More <HiArrowNarrowRight className="text-gray-100 text-sm mt-1.5 ml-1" />
                  </motion.button>
              </div>
              <div className='col-span-1'></div>
          </div>
