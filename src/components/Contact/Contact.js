...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <section class="bg-white pt-10 pb-8 lg:pt-[60px] lg:pb-[40px] overflow-hidden relative z-10">
        <div class="container">
            <div class="flex flex-wrap lg:justify-between -mx-4">
              <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                  <div class="max-w-[570px] mb-12 lg:mb-0">
                    <span class="block mb-4 text-base text-[#369e9e] font-semibold">
                    Contact Us
                    </span>
                    <h2
                        class="
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                          <h4 class="font-bold text-gray-700 text-xl mb-1">Our Location</h4>
                          <p class="text-base text-body-color">
                              Mirpur road, Dhanmondi, Dhaka.
                          </p>
                        </div>
                    </div>
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                          <h4 class="font-bold text-gray-700 text-xl mb-1">Phone Number</h4>
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                          <h4 class="font-bold text-gray-700 text-xl mb-1">
                              Email Address
                          </h4>
              ...
              <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                  <div class="bg-white relative rounded-lg p-8 sm:p-12 drop-shadow-lg">
                    <form>
                        <div class="mb-6">
                          <input
                              type="text"
